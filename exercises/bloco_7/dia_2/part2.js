...
const returnValuesOfKeys = (object, position) => Object.values(object)[position];
console.log(returnValuesOfKeys(lesson1, 3));

// Crie uma função que verifique se o par (chave / valor) existe na função. Essa função deve possuir três parâmetros, sendo eles: o objeto, o nome da chave e o valor da chave.

const checkIfPairExist = (objeto, nomeChave, valorChave) => {
const teste = (Object.entries(objeto));
let isTrue = false;
for (let index in teste){
  if (teste[index][0] === nomeChave && teste[index][1] === valorChave) isTrue = true;
}
return isTrue;
};

console.log(checkIfPairExist(lesson2,'materia','História'));